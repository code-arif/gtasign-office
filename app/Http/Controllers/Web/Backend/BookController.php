...
class BookController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('backend.layouts.book.edit', compact('product', 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.book.index')->with('success', 'Product updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.book.index')->with('success', 'Product deleted successfully');
    }
    ...
    public function variant(Request $request, $id)
    {
        ...
        return view('backend.layouts.book.variant', compact('product'));
