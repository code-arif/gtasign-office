...
<body>
    <div class="payment-demo">
        ...
        <div class="card cancel">
            ...
            <div class="icon">✕</div>
            <h2>Canceled</h2>
            <div class="message">The payment was not completed.</div>

            <!-- tiny meta row -->
            <div class="detail-row">
                <span class="detail-item">💳 •••0000</span>
                <span class="dot"></span>
                <span class="detail-item">🕒 pending</span>
                <span class="dot"></span>
                <span class="detail-item">⚠️ no charge</span>
            </div>

            <!-- actions for cancel/retry etc -->
            <div class="actions">
                <button class="btn btn-secondary" onclick="alert('↻ try again (demo)')">↻ Try again</button>
                <button class="btn btn-primary" onclick="alert('🏠 return home (demo)')">Home</button>
            </div>

            <div class="demo-hint">
                <span>canceled</span>
                <span style="background:#fff1f3;">#no payment</span>
            </div>
        </div>
    </div>
</body>
