                        ...
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <form class="form form-horizontal" method="post"
                                    action="{{ route('admin.setting.logo.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                    ...
                    <div class="col-lg-5">
                        <div class="card box-shadow-0">
                            <div class="card-body text-center">
                                <img id="logo-preview"
                                    src="{{ !empty($setting->logo) && file_exists(public_path($setting->logo)) ? asset($setting->logo) : asset('default/logo.svg') }}"
                                    alt="Logo" width="{{ $setting->logo_width ?? 240 }}"
                                    height="{{ $setting->logo_height ?? 240 }}" />
                            </div>
                        </div>
                    </div>
